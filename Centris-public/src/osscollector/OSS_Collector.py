...
def main(pid_str):
    ...
    with open(gitCloneURLS, 'r', encoding="UTF-8") as fp:
        ...
        for eachUrl in lines:
            ...
            print(pid_str, "[+] Processing", repoName)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='process_id_str')
    parser.add_argument('process_id_str', type=str, help='process id string')

    args = parser.parse_args()
    process_id_str = args.process_id_str
    gitCloneURLS = gitCloneURLS + "_"+ process_id_str
    clonePath = currentPath + "/repo_src_" + process_id_str + "/"
    main(process_id_str)