...
verIDXpath = currentPath + "/verIDX_3000lite/"  # Default path
initialDBPath = currentPath + "/initialSigs_3000lite/"  # Default path
finalDBPath = currentPath + "/componentDB_3000lite/"  # Default path
metaPath = currentPath + "/metaInfos_3000lite/"  # Default path
weightPath = metaPath + "/weights_3000lite/"
funcDatePath = currentPath + "/funcDate_3000lite/"  # Default path
        ...
        with open(initialDBPath + S_sig, 'r', encoding="UTF-8") as fs:
            ...
            if len(jsonStr) == 0:
                ...
                if S not in possibleMembers:
                    ...
                    saveJson = []
                    with open("./3000test/" + "removedFuncNumLite", 'w') as fres:
